...
from .g1_testbench_marl_env_cfg import G1TestbenchMarlEnvCfg


class G1TestbenchMarlEnv(DirectMARLEnv):
    cfg: G1TestbenchMarlEnvCfg

    def __init__(self, cfg: G1TestbenchMarlEnvCfg, render_mode: str | None = None, **kwargs):
